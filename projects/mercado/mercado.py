        ...
        if produto:
            if len(carrinho) > 0:
                ...
                for item in carrinho:
                    qnt: int = item.get(produto)
                    if qnt:
                        item[produto] = qnt + 1
                        print(f'O produto {produto.nome} agora possui {qnt + 1} unidades no carrinho.')
                ...
                print(f'O produto {produto.nome} foi adicionado a carrinho.')
                sleep(2)
                menu()
    else:
